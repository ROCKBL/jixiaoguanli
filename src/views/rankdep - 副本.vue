<template>
	<div class="rank">
		<van-nav-bar title="部门排行榜"  left-arrow class="pageNavNative" @click-left="onClickLeft" />
		...
		<div class="rankList">
			...
			<div v-for="(item,index) in list" class="rankListRow">
				<div class="rankListFirst rankListColumn">{{ index+1 }}</div>
	...
	methods:{
	  ...
	  //   	var that=this;
	    ...
	    getTj(){
	    	...
	    	this.axios({
				method: 'get',
				url: this.baseUrl+"/departIntegral/personDepartRanking",
				params: {
